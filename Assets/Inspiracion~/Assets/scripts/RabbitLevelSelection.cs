...
public class RabbitLevelSelection : MonoBehaviour {
	...
	void Start () 
	{
		completedlevels = PlayerPrefs.GetInt("RabbitLevelCompleted");
		titlename = "Rabbit Levels";
	}
	...
	void OnGUI()
	{
		...
		if(completedlevels >= 2)
		{
			if(GUI.Button(new Rect(70, originalHeight / 2 + 70, 112, 112), "", levelstyle2))
			{
				...
				PlayerPrefs.SetInt ("RabbitLevel2", 1);
				PlayerPrefs.SetInt ("RabbitLevel3", 0);
				PlayerPrefs.SetInt ("RabbitLevel4", 0);
				PlayerPrefs.SetInt ("RabbitLevel5", 0);
				PlayerPrefs.SetInt ("RabbitLevel6", 0);
				...
				GUI_Controller.hint = "Hunt Three Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 3)
		{
			if(GUI.Button(new Rect(originalWidth / 2 - 200, originalHeight / 2 - 80 , 112, 112), "", levelstyle3))
			{
				PlayerPrefs.SetInt ("RabbitLevel1", 0);
				PlayerPrefs.SetInt ("RabbitLevel2", 0);
				PlayerPrefs.SetInt ("RabbitLevel3", 1);
				PlayerPrefs.SetInt ("RabbitLevel4", 0);
				PlayerPrefs.SetInt ("RabbitLevel5", 0);
				PlayerPrefs.SetInt ("RabbitLevel6", 0);
				PlayerPrefs.SetInt ("RabbitLevel7", 0);
				...
				GUI_Controller.time_Limit = 28;
				GUI_Controller.hint = "Hunt Two Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 4)
		{
			if(GUI.Button(new Rect(originalWidth / 2 - 180, originalHeight / 2 + 70, 112, 112), "", levelstyle4))
			{
				...
				PlayerPrefs.SetInt ("RabbitLevel2", 0);
				PlayerPrefs.SetInt ("RabbitLevel3", 0);
				PlayerPrefs.SetInt ("RabbitLevel4", 1);
				PlayerPrefs.SetInt ("RabbitLevel5", 0);
				PlayerPrefs.SetInt ("RabbitLevel6", 0);
				PlayerPrefs.SetInt ("RabbitLevel7", 0);
				PlayerPrefs.SetInt ("RabbitLevel8", 0);
				...
				GUI_Controller.hint = "Hunt Four Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 5)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 40, originalHeight / 2 - 80 , 112, 112), "", levelstyle5))
			{
				...
				PlayerPrefs.SetInt ("RabbitLevel3", 0);
				PlayerPrefs.SetInt ("RabbitLevel4", 0);
				PlayerPrefs.SetInt ("RabbitLevel5", 1);
				PlayerPrefs.SetInt ("RabbitLevel6", 0);
				PlayerPrefs.SetInt ("RabbitLevel7", 0);
				PlayerPrefs.SetInt ("RabbitLevel8", 0);
				...
				GUI_Controller.hint = "Hunt Five Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 6)
		{
			if(GUI.Button(new Rect(originalWidth / 2  + 80, originalHeight / 2 + 70 , 112, 112), "", levelstyle6))
			{
				...
				PlayerPrefs.SetInt ("RabbitLevel4", 0);
				PlayerPrefs.SetInt ("RabbitLevel5", 0);
				PlayerPrefs.SetInt ("RabbitLevel6", 1);
				PlayerPrefs.SetInt ("RabbitLevel7", 0);
				PlayerPrefs.SetInt ("RabbitLevel8", 0);
				
				DragonCounter.totalanimals = 6;
				GUI_Controller.time_Limit = 40;
				GUI_Controller.hint = "Hunt Six Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 7)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 280, originalHeight / 2 -  80, 112, 112), "", levelstyle7))
			{
				...
				PlayerPrefs.SetInt ("RabbitLevel5", 0);
				PlayerPrefs.SetInt ("RabbitLevel6", 0);
				PlayerPrefs.SetInt ("RabbitLevel7", 1);
				PlayerPrefs.SetInt ("RabbitLevel8", 0);
				
				DragonCounter.totalanimals = 7;
				GUI_Controller.time_Limit = 50;
				GUI_Controller.hint = "Hunt Seven Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 8)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 320, originalHeight / 2  + 70 , 112, 112), "", levelstyle8))
			{
				...
				PlayerPrefs.SetInt ("RabbitLevel6", 0);
				PlayerPrefs.SetInt ("RabbitLevel7", 0);
				PlayerPrefs.SetInt ("RabbitLevel8", 1);
				
				DragonCounter.totalanimals = 8;
				GUI_Controller.time_Limit = 60;
				GUI_Controller.hint = "Hunt Eight Rabbit by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
