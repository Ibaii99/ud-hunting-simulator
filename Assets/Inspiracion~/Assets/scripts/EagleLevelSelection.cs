...
public class EagleLevelSelection : MonoBehaviour {
	...
	void Start () 
	{
		completedlevels = PlayerPrefs.GetInt("EagleLevelCompleted");
		titlename = "Eagle Levels";
	}
	...
	void OnGUI()
	{
		...
		{
			PlayerPrefs.SetInt ("Eaglelevel1", 1);
		...
		if(completedlevels >= 2)
		{
			if(GUI.Button(new Rect(70, originalHeight / 2 + 70, 112, 112), "", levelstyle2))
			{
				...
				GUI_Controller.hint = "Hunt Two Eagle by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 3)
		{
			if(GUI.Button(new Rect(originalWidth / 2 - 200, originalHeight / 2 - 80 , 112, 112), "", levelstyle3))
			{
				PlayerPrefs.SetInt ("Eaglelevel1", 0);
				PlayerPrefs.SetInt ("Eaglelevel2", 0);
				PlayerPrefs.SetInt ("Eaglelevel3", 1);
				PlayerPrefs.SetInt ("Eaglelevel4", 0);
				PlayerPrefs.SetInt ("Eaglelevel5", 0);
				PlayerPrefs.SetInt ("Eaglelevel6", 0);
				PlayerPrefs.SetInt ("Eaglelevel7", 0);
				...
				GUI_Controller.hint = "Hunt Four Eagle by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 4)
		{
			if(GUI.Button(new Rect(originalWidth / 2 - 180, originalHeight / 2 + 70, 112, 112), "", levelstyle4))
			{
				...
				GUI_Controller.hint = "Hunt Six Eagle by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 5)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 40, originalHeight / 2 - 80 , 112, 112), "", levelstyle5))
			{
				...
				PlayerPrefs.SetInt ("Eaglelevel3", 0);
				PlayerPrefs.SetInt ("Eaglelevel4", 0);
				PlayerPrefs.SetInt ("Eaglelevel5", 1);
				PlayerPrefs.SetInt ("Eaglelevel6", 0);
				PlayerPrefs.SetInt ("Eaglelevel7", 0);
				PlayerPrefs.SetInt ("Eaglelevel8", 0);			
		...
		if(completedlevels >= 6)
		{
			if(GUI.Button(new Rect(originalWidth / 2  + 80, originalHeight / 2 + 70 , 112, 112), "", levelstyle6))
			{
				...
				PlayerPrefs.SetInt ("Eaglelevel4", 0);
				PlayerPrefs.SetInt ("Eaglelevel5", 0);
				PlayerPrefs.SetInt ("Eaglelevel6", 1);
				PlayerPrefs.SetInt ("Eaglelevel7", 0);
				PlayerPrefs.SetInt ("Eaglelevel8", 0);			
		...
		if(completedlevels >= 7)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 280, originalHeight / 2 -  80, 112, 112), "", levelstyle7))
			{
				...
				PlayerPrefs.SetInt ("Eaglelevel5", 0);
				PlayerPrefs.SetInt ("Eaglelevel6", 0);
				PlayerPrefs.SetInt ("Eaglelevel7", 1);
				PlayerPrefs.SetInt ("Eaglelevel8", 0);			
				
				DragonCounter.totalanimals = 8;
				GUI_Controller.time_Limit = 50;
				GUI_Controller.hint = "Hunt Eight Eagle by sniper gun.";
				#if UNITY_ANDROID
				Handheld.SetActivityIndicatorStyle(AndroidActivityIndicatorStyle.Small);
				#endif
				Handheld.StartActivityIndicator();
		...
		if(completedlevels >= 8)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 320, originalHeight / 2  + 70 , 112, 112), "", levelstyle8))
			{
				...
				PlayerPrefs.SetInt ("Eaglelevel6", 0);
				PlayerPrefs.SetInt ("Eaglelevel7", 0);
				PlayerPrefs.SetInt ("Eaglelevel8", 1);			
