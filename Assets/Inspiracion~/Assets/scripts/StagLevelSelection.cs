...
public class StagLevelSelection : MonoBehaviour {
	...
	void Start () 
	{
		completedlevels = PlayerPrefs.GetInt("StagLevelCompleted");
		titlename = "Stag Levels";
	}
...
//				Application.LoadLevel("Level3");
		...
		if(completedlevels >= 5)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 40, originalHeight / 2 - 80 , 112, 112), "", levelstyle5))
			{
				...
				PlayerPrefs.SetInt ("Staglevel3", 0);
				PlayerPrefs.SetInt ("Staglevel4", 0);
				PlayerPrefs.SetInt ("Staglevel5", 1);
				PlayerPrefs.SetInt ("Staglevel6", 0);
				PlayerPrefs.SetInt ("Staglevel7", 0);
				PlayerPrefs.SetInt ("Staglevel8", 0);
		...
		if(completedlevels >= 6)
		{
			if(GUI.Button(new Rect(originalWidth / 2  + 80, originalHeight / 2 + 70 , 112, 112), "", levelstyle6))
			{
				...
				PlayerPrefs.SetInt ("Staglevel4", 0);
				PlayerPrefs.SetInt ("Staglevel5", 0);
				PlayerPrefs.SetInt ("Staglevel6", 1);
				PlayerPrefs.SetInt ("Staglevel7", 0);
				PlayerPrefs.SetInt ("Staglevel8", 0);
		...
		if(completedlevels >= 7)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 280, originalHeight / 2 -  80, 112, 112), "", levelstyle7))
			{
				...
				PlayerPrefs.SetInt ("Staglevel5", 0);
				PlayerPrefs.SetInt ("Staglevel6", 0);
				PlayerPrefs.SetInt ("Staglevel7", 1);
				PlayerPrefs.SetInt ("Staglevel8", 0);
				...
				GUI_Controller.hint = "Hunt Seven Stag's by sniper gun.";
		...
		if(completedlevels >= 8)
		{
			if(GUI.Button(new Rect(originalWidth / 2 + 320, originalHeight / 2  + 70 , 112, 112), "", levelstyle8))
			{
				...
				PlayerPrefs.SetInt ("Staglevel6", 0);
				PlayerPrefs.SetInt ("Staglevel7", 0);
				PlayerPrefs.SetInt ("Staglevel8", 1);
